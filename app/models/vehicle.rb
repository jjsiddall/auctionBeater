...
# TESTING OFF: turning this off while I am doing code other places (so I dont keep hitting the site)
		data_id = getDataId(auctionID)
# TESTING ON: will use this for debuging	
		#data_id = "testing"
...
# TESTING OFF: turning this off while I work on other areas of the site
